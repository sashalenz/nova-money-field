        ...
        <template slot="field">
            <div class="flex flex-wrap items-stretch w-full relative">
                <div class="flex -mr-px">
                    <span class="flex items-center bg-30 rounded-r-none px-3 whitespace-no-wrap text-sm form-control form-input-bordered">{{ field.value.currency }}</span>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
             ...
             */
            setInitialValue() {
                this.value = this.field.value.amount/100 || 0
            },
